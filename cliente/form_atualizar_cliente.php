          ...
          >
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
                ...
                <span class="text-muted fw-light">Atualizar/</span>Cliente:</h4>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarsExample03">
        <ul class="navbar-nav me-auto mb-2 mb-sm-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="consulta_cliente.php">Consulta:</a>
          </li>
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="#">Nome</a></li>
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                      <form id="frm_atualizar_cliente" method="POST" action="atualizar_cliente.php">
                        <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control"  value="<?php echo $dados['cli_nome']; ?>" type="text" name="txt_nome"  id="txt_nome" style="background-color: whitesmoke" placeholder="Digite o campo Nome:"/>
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="txt_telefone" class="form-label">Telefone:</label>
                            <input class="form-control"  value="<?php echo $dados['cli_telefone']; ?>" type="text" name="txt_telefone"  onkeypress="mascara(this, '## ####-####')"  maxlength="12" id="txt_telefone" style="background-color: whitesmoke" placeholder="Digite o campo Telefone:"/>
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="txt_cpf" class="form-label">CPF:</label>
                            <input class="form-control"  value="<?php echo $dados['cli_cpf']; ?>" type="text" name="txt_cpf" onkeypress="mascara(this, '###.###.###-##')" maxlength="14" id="txt_cpf" style="background-color: whitesmoke" placeholder="Digite o campo CPF:" />
                          </div>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input
                              class="form-control"
                              value="<?php echo $dados['cli_numero']; ?>"
                              type="text"
                              id="txt_numero"
                              name="txt_numero"
                              style="background-color: whitesmoke"
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input
                              class="form-control"
                              value="<?php echo $dados['cli_bairro']; ?>"
                              type="text"
                              id="txt_bairro"
                              name="txt_bairro"
                              style="background-color: whitesmoke"
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input
                              class="form-control"
                              value="<?php echo $dados['cli_cidade']; ?>"
                              type="text"
                              id="txt_cidade"
                              name="txt_cidade"
                              style="background-color: whitesmoke"
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <select id="txt_estado" name="txt_estado" class="select2 form-select" value="<?php echo $dados['cli_estado']; ?>" style="background-color: whitesmoke" required>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input
                              class="form-control"
                              value="<?php echo $dados['cli_complemento']; ?>"
                              type="text"
                              id="txt_complemento"
