  ...
  <body>
          ...
          >
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
                ...
                <span class="text-muted fw-light"></span>Relatóiro / Produtos / Consulta:
    ...
    <div class="container-fluid">
      ...
      <div class="card border-left-primary shadow h-100 py-2">
                            ...
                            $query_valor = "SELECT SUM(pro_codigo) AS valor_cadastro FROM tb_produto"; $result_valor = $conn->prepare($query_valor); $result_valor->execute();
                            $row_valor = $result_valor->fetch(PDO::FETCH_ASSOC); echo $row_valor['valor_cadastro'] ;  
                            ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total de Vendas:</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Total: 1</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                        </div>
