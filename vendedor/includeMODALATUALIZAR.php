    ...
    <form method="POST" id="exampleModal" action="atualizar_vendedor.php" enctype="multipart/form-data">
        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="recipient-empresa" name="txt_empresa"  placeholder="Digite o campo empresa:">
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <input type="text" id="recipient-email" name="txt_email" class="form-control" placeholder="Digite o campo email:" aria-label="john.doe" aria-describedby="basic-default-email2">
                            </div>
                          </div>
                      </div>
                        <div class="row mb-3">
