...
$cons_empresa = isset($_REQUEST['txt_cons_empresa']) ? $_REQUEST['txt_cons_empresa'] : '';
...
$sql = "select *, date_format(ven_data_cadastro,'%d/%m/%Y') as data
        from tb_vendedor
        where 
          ven_codigo like '%".$cons_codigo."%'AND
          ven_nome like '%".$cons_nome."%'AND
          ven_empresa like '%".$cons_empresa."%'AND
          ven_email like '%".$cons_email."%'AND
          ven_data_cadastro like '%".$cons_data_cadastro."%'
       ";
...
<script>
          ...
          >
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
                ...
                <span class="text-muted fw-light">Vendedor/</span> Consulta
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
                <div class="col-md-12">
                    ...
                    <!-- Notifications -->
                    <div class="card">
                    <button class="dt-button create-new btn btn-primary" data-toggle="modal" data-target="#exampleModal1" tabindex="0"  type="button"><span><i class="bx bx-plus me-2"></i> <span class="d-none d-lg-inline-block"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Adicionar novo registro</font></font></span></span></button>
  </div>
  <br>
                    <div class="card">
  ...
  <path d="M8 2a5.53 5.53 0 0 0-3.594 1.342c-.766.66-1.321 1.52-1.464 2.383C1.266 6.095 0 7.555 0 9.318 0 11.366 1.708 13 3.781 13h8.906C14.502 13 16 11.57 16 9.773c0-1.636-1.242-2.969-2.834-3.194C12.923 3.999 10.69 2 8 2zm2.354 5.146a.5.5 0 0 1-.708.708L8.5 6.707V10.5a.5.5 0 0 1-1 0V6.707L6.354 7.854a.5.5 0 1 1-.708-.708l2-2a.5.5 0 0 1 .708 0l2 2z"/>
                      ...
                      <td> <?php echo $dados['ven_empresa']; ?> </td>
                      <td> <?php echo $dados['ven_email']; ?> </td>
  ...
  <a type="button" class="btn btn-secondary"  href="delete_vendedor.php?ven_codigo=<?php echo $dados['ven_codigo']; ?>" onclick="excluir_registro(event)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-trash-fill" viewBox="0 0 16 16">
