        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Cadastrar/</span>Cliente:</h4>

              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link active" href="javascript:void(0);"><i class="bx bx-user me-1"></i>Cliente</a>
                    </li>
                    <li class="nav-item">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body" style="margin-left: 440px;">
                      <form id="formAccountSettings" method="POST" onsubmit="return false">
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="cidade" class="form-label">Email:</label>
                            <input type="text" class="form-control" id="bairro" name="ciade"/>
                          </div>
                          <div class="mb-3 col-md-6">
