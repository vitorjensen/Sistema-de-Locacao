      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Cadastrar/</span>News:</h4>

            <div class="row">
              <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                  <li class="nav-item">
                    <a class="nav-link active" href="javascript:void(0);"><i class="bx bx-user me-1"></i>News</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="consulta_news.php"
                  ...
                  <div class="card-body">
                    <form id="formAccountSettings" method="POST" onsubmit="return false">
                      <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                          <label for="cpf" class="form-label">Autor:</label>
                          <input
                            class="form-control"
                            type="text"
                            id="cpf"
                        ...
                        <div class="mb-3 col-md-6">
                          <label for="rua" class="form-label">Data de publicação:</label>
                          <input
                            type="date"
                            class="form-control"
                            id="rua"
