          ...
          >
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
                ...
                <span class="text-muted fw-light">Cadastrar/</span>Aluguel:</h4>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarsExample03">
        <ul class="navbar-nav me-auto mb-2 mb-sm-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="consulta_aluguel.php">Consulta:</a>
          </li>
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="#">Nome</a></li>
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                      <form id="form_venda" method="POST" action="cadastrar_aluguel.php">
                        <div class="row">
                        ...
                        <div class="mt-2">
                          <button type="submit" class="btn btn-primary me-2" onclick="return validar_dados()">  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
